package com.obvious.nasa.injection.base
...
import com.obvious.nasa.NasaStarterApplication
import com.obvious.nasa.injection.component.ActivityComponent
import com.obvious.nasa.injection.component.ConfigPersistentComponent
import com.obvious.nasa.injection.component.DaggerConfigPersistentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (componentsArray.get(activityId) == null) {
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .appComponent(NasaStarterApplication[this].component)
                    .build()
